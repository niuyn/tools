// Package transforms GPS coordinates between earth(WGS-84) and mars in china(GCJ-02).
// Adapted from other sources, and NO rights reserved
//
// History
package gcj02
...
func isValid(lat, lon float64) bool {
	latAbs := math.Abs(lat)
	lonAbs := math.Abs(lon)
